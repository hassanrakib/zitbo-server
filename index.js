...
if (!dbUser || !dbPass) {
  console.error("Missing DB_USER or DB_PASSWORD in environment (.env)");
  process.exit(1);
}
const uri = `mongodb+srv://${encodeURIComponent(dbUser)}:${encodeURIComponent(dbPass)}@zitbo-1.8pinoyh.mongodb.net/?retryWrites=true&w=majority`;
